...
import com.esme.auth.entity.Client;
import com.esme.auth.repository.ClientRepository;
...
public class JpaRegisteredClientService implements RegisteredClientRepository {
    ...
    static AuthorizationGrantType getAuthorizationGrantType(String authorizationGrantType) {
