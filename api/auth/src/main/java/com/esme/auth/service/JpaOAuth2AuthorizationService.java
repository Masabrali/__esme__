...
import com.esme.auth.repository.UserAuthorizationRepository;
...
import static com.esme.auth.service.JpaRegisteredClientService.getAuthorizationGrantType;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    public OAuth2Authorization findByToken(String token, OAuth2TokenType tokenType) {
        ...
        Optional<UserAuthorization> result;
        if (tokenType == null) {
    ...
    private OAuth2Authorization toObject(UserAuthorization entity) {
    ...
    private UserAuthorization toEntity(OAuth2Authorization authorization) {
